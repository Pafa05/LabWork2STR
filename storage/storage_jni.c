...
JNIEXPORT jint JNICALL Java_Storage_getPos(JNIEnv* jniEnv, jclass jclass) {
	return getXPos();
}
...
JNIEXPORT jint JNICALL Java_Storage_getSwitchh1_12(JNIEnv* jniEnv, jclass jclass) {
	return getSwitch1_2();
}
JNIEXPORT void JNICALL Java_Storage_ledOn(JNIEnv* jniEnv, jclass jclass, jint n) {
	ledOn(n);
}
JNIEXPORT void JNICALL Java_Storage_ledOff(JNIEnv* jniEnv, jclass jclass) {
	ledsOff();
}